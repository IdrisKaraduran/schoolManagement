...
public class EmailService {
    ...
    public static void sendMail(String recipient,String mailMessage,String subject) throws MessagingException {
        ...
        Session session = Session.getInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(MAIL_ADDRESS,PASSWORD);//bU YAPI BU IKI IFADEYI ACIK BIR SEKILDE GONDERMEMI ENGEL OLUYOR.
            }
        });
    ...
    private static Message prepareMessage(
            Session session,String from, String recipient,
